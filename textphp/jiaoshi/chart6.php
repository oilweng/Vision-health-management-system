            ...
            series : [
                {
                    ...
                    data:[          // 数据数组，name 为数据项名称，value 为数据项值
                        {value:query1, name:'红色盲'},
                        {value:query2, name:'绿色盲'},
                        {value:query3, name:'蓝光色盲'},
                        {value:query4, name:'正常'},
