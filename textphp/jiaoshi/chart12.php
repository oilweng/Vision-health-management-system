...
$aas3 = -6.00;
$ass4 = 1;
$sql1="select * from datadata where SE >= '$aas2' and SE < '$aas1' and banji = $ass4 ";
    $result_user1=mysqli_query($conn,$sql1);//执行对数据库的查询
    $rows1=mysqli_num_rows($result_user1);
    // print_r($rows1)
$sql2="select * from datadata where SE >= '$aas3' and SE < '$aas2' and banji = $ass4";
    $result_user2=mysqli_query($conn,$sql2);//执行对数据库的查询
    $rows2=mysqli_num_rows($result_user2);
$sql3="select * from datadata where SE < '$aas3' and banji = $ass4";
